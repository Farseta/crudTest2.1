...
class PrintController extends Controller
{
    ...
    public function api(){
        ...
        // gas_last
        ->addColumn('last_gas',function($vehicle_lendings){
            return $vehicle_lendings->transportation->gas_last;
        })
        // last_km
        ->addColumn('last_km',function($vehicle_lendings){
            return $vehicle_lendings->transportation->last_km;
        })
        // gas_money
        ->addColumn('gas_money_last',function($vehicle_lendings){
            return $vehicle_lendings->gas_money;
        })
        // gas_money
        ...
        // lending_Status
        ->addColumn('status_lending',function($vehicle_lendings){
            return $vehicle_lendings->status_lending;
        })
        ...
        ->addColumn('date_convert_created_at_lending',function($vehicle_lendings){
            return date_convert($vehicle_lendings->created_at);
        })
