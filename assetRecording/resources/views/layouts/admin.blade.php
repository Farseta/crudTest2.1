        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ url('home') }}" class="brand-link">
                <img src="{{ asset('assets/dist/img/logo2.png') }}" alt="AdminLTE Logo"
                    class="brand-image-xl img-circle elevation-3" style="opacity: .8">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('assets/dist/img/profile.png') }}" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
                ...
                with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item  {{ request()->is('vehicleLends') ? 'menu-open' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('vehicleLends') }}"
                                        class="nav-link {{ request()->is('vehicleLends') ? 'active' : '' }}">
                        ...
                        <li class="nav-item  {{ request()->is('vehicleReturns') ? 'menu-open' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('vehicleReturns') }}"
                                        class="nav-link {{ request()->is('vehicleReturns') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Mobil</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ url('otherAssets') }}"
                                class="nav-link {{ request()->is('otherAssets') ? 'active' : '' }} ">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active"><a href="@yield('sideTittle')">@yield('title')</a>
                                </li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
