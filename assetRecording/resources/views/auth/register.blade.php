        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('register') }}" method="post">
                    ...
                    <div class="input-group mb-3">
                        <select class="custom-select form-control " aria-label="Default select example" id="role"
                            @error('role') is-invalid @enderror name="role" required>
            ...
            <a href="/login" class="text-center mb-2" >Saya Sudah Mempunyai Akun</a>
            <!-- /.form-box -->
        </div><!-- /.card -->
    </div>
    <!-- /.register-box -->
